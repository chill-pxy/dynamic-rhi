...
namespace DRHI
{
    ...
    void VulkanDRHI::frameOnTick(void (*recreateFunc)())
    {
    ...
    void VulkanDRHI::prepareFrame(void (*recreateFunc)())
    {
    ...
    void VulkanDRHI::submitFrame(void (*recreateFunc)())
    {
